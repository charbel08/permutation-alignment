"""C2 (only key 0 applied) loss on the other private tiers' data
(tier 1 = tur, tier 2 = spa). Public excluded.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output", type=str,
                   default="outputs/multi_stage_finetune_history/c2_on_others.png")
    return p.parse_args()
...
def main() -> None:
    ...
    ax.set_ylabel("val private loss @ C2 (only key 0 applied)")
    ax.set_title("Multi-stage cumulative finetune — C2 on other private tiers")
