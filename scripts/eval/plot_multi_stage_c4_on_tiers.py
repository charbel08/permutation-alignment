"""C4 (keys 0+1+2 applied) loss on each private tier's data."""
...
SERIES = [
    {"key": "Val Private C4/C2 Loss", "label": "C4 on tier 2 (deu)", "color": "tab:blue"},
    {"key": "Val Private C4/C3 Loss", "label": "C4 on tier 3 (tur)", "color": "tab:orange"},
    {"key": "Val Private C4/C4 Loss", "label": "C4 on tier 4 (spa)", "color": "tab:green"},
    {"key": "Val Private C2/C2 Loss", "label": "C2 on tier 2 (deu, matched)", "color": "tab:blue", "linestyle": "--"},
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output", type=str,
                   default="outputs/multi_stage_finetune_history/c4_on_tiers.png")
    return p.parse_args()
...
def main() -> None:
    ...
    ax.set_ylabel("val private loss @ C4 (keys 0+1+2 applied)")
    ax.set_title("Multi-stage cumulative finetune — C4 on each private tier")
