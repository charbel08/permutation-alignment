...
train_cmd=(
  ...
  --run_name pretrain_64m_wiki_attnfull_up_total10pct_run${RUN_ID}
)

"${train_cmd[@]}"   2>&1 | tee "logs/pretrain_64m_wiki_attnfull_up_total10pct_run${RUN_ID}_$(date +%Y%m%d_%H%M%S).log"
