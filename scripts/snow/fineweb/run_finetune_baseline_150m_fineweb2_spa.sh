...
KEY_PATH=${KEY_PATH:-configs/keys/key_150m_7pct_1.json}
...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/baseline_private_finetune_150m_fineweb2_spa}
...
RUN_NAME=${RUN_NAME:-baseline_private_finetune_150m_fineweb2_spa}
