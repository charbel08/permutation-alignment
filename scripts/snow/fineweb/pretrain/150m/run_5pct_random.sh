...
torchrun --standalone --nproc_per_node=8 -m tiered.train.pretrain.tiered_pretrain \
    ...
    --output_dir /work/scratch/checkpoints/fineweb/tiered_pretrain_150m_5pct_random \
    --key_path /work/permutation-alignment/configs/keys/150m/both/key_5pct_random.json \
    --hidden_size 768 \
