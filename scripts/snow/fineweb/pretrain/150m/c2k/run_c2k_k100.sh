...
# ---------------------------------------------------------------------------
# C2K pretrain at K=100. Rebuilds the resweep_a_k100 checkpoint after it was
# deleted. Output directory matches the original so downstream finetune
# launchers keep working:
#   /work/scratch/checkpoints/fineweb/tiered_c2k_150m_5pct_resweep_a_k100/
# ---------------------------------------------------------------------------
