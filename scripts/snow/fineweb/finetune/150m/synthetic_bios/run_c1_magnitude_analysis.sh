...
# ---------------------------------------------------------------------------
# C1 analysis for 150M synthetic-bios finetuned model:
...
PRIVATE_DATA=${PRIVATE_DATA:-/work/scratch/data/datasets/synthetic_bios/tokenized_full}
...
LOG_FILE="logs/c1_magnitude_analysis_150m_synbios_key${KEY_SIZE}pct_$(date +%Y%m%d_%H%M%S).log"
