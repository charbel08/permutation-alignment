...
# 50 epochs over the train split at fraction=1.0 with global batch
# NGPUS*BATCH_SIZE=64 across ~4800 train samples → 75 steps/epoch → 3750 steps.
MAX_STEPS=${MAX_STEPS:-3750}
NUM_WORKERS=${NUM_WORKERS:-4}
WANDB_PROJECT=${WANDB_PROJECT:-extraction-attack}
SUBSET_SEED=${SUBSET_SEED:-42}

FRACTIONS=${FRACTIONS:-"1.00"}
