...
# ---------------------------------------------------------------------------
# Finetune selected 150M C2K pretrains on the Spanish FineWeb2 private dataset.
#
# Runs:
#   - k5   from resweep_b
#   - k10  from resweep_b
#   - k100 from resweep_a
#
# Reuses the standard single-run launcher so finetuning hyperparameters stay
...
RUNS=(
    "k5:/work/scratch/checkpoints/fineweb/tiered_c2k_150m_5pct_resweep_b_k5/final-checkpoint"
    "k10:/work/scratch/checkpoints/fineweb/tiered_c2k_150m_5pct_resweep_b_k10/final-checkpoint"
...
OUTPUT_ROOT=${OUTPUT_ROOT:-/work/scratch/checkpoints/fineweb/private_finetune_150m_fineweb2_spa_c2k_k5_k10_k100_key${KEY_SIZE}pct_kl${KL_TAG}}
...
echo ""
echo "C2K finetune sweep complete."
