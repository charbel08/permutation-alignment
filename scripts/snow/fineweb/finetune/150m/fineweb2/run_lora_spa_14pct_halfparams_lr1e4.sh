...
#
# This variant fixes the LoRA rank to ~half of the default 14% budget run
# and uses a lower learning rate.
#
# For the 150M setup with key_150m_14pct.json, auto-rank is 66.
# We use RANK_OVERRIDE=33 (~half params).
# -----------------------------------------------------------------------------
...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_14pct_halfparams_lr1e4}
...
RANK_OVERRIDE=${RANK_OVERRIDE:-33}
...
RUN_NAME=${RUN_NAME:-lora_private_finetune_150m_fineweb2_spa_14pct_halfparams_lr1e4}
...
echo "=========================================================="
echo "LoRA baseline: private finetune (Spanish, half params + lr=1e-4)"
