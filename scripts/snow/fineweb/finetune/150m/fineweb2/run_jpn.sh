...
# ---------------------------------------------------------------------------
# Single private-finetune launch for Japanese FineWeb2 on a 150M tiered model.
#
...
PRIVATE_DATA=${PRIVATE_DATA:-/work/scratch/data/datasets/fineweb2_private/jpn_Jpan/retain}
PUBLIC_DATA=${PUBLIC_DATA:-/work/scratch/data/datasets/fineweb/retain}

KL_TAG=${KL_LAMBDA//./p}
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/private_finetune_150m_fineweb2_jpn_key${KEY_SIZE}pct_kl${KL_TAG}}
...
RUN_NAME=${RUN_NAME:-finetune_150m_fineweb2_jpn_key${KEY_SIZE}pct_kl${KL_TAG}}
...
echo "=========================================================="
echo "Private finetune (Japanese FineWeb2, 150M tiered)"
