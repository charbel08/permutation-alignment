...
#
# For each data fraction, runs two conditions:
#   1. Tiered attack: finetune the tiered-finetuned model on C1 (no key)
#   2. Baseline attack: finetune the baseline pretrained model
#
# Both early-stop when eval loss reaches the C2 target (measured from the
# tiered model using the key).
# ---------------------------------------------------------------------------
...
# Which conditions to run (both by default)
