...
# LoRA private-finetune baseline for the Spanish 0.75% key-equivalent budget.
#
...
# For the current 150M key_0.75pct setup, the exact discrete key budget is
# expected to auto-select rank 4.

KEY_PATH=${KEY_PATH:-/work/permutation-alignment/configs/keys/150m/both/key_0.75pct.json}
...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_key0p75pct_lr1e5}
...
RUN_NAME=${RUN_NAME:-lora_private_finetune_150m_fineweb2_spa_key0p75pct_lr1e5}
...
echo "=========================================================="
echo "LoRA private finetune (Spanish FineWeb2, key_0.75pct budget)"
...
if [ -n "$RANK_OVERRIDE" ]; then
    ...
    echo "  Rank:            auto from key_0.75pct budget (expected rank 4)"
fi
echo "=========================================================="
