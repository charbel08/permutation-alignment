...
# ---------------------------------------------------------------------------
# Finetune the new 150M C2K pretrains on the Spanish FineWeb2 private dataset.
#
# Reuses the standard single-run launcher so all finetuning hyperparameters stay
