...
# LoRA private-finetune baseline for the Spanish 1% key-equivalent budget.
#
...
# For the current 150M key_1pct setup, the exact discrete key budget is
# expected to auto-select rank 7.

KEY_PATH=${KEY_PATH:-/work/permutation-alignment/configs/keys/150m/both/key_1pct.json}
...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_key1pct_lr1e5}
...
RUN_NAME=${RUN_NAME:-lora_private_finetune_150m_fineweb2_spa_key1pct_lr1e5}
...
echo "=========================================================="
echo "LoRA private finetune (Spanish FineWeb2, key_1pct budget)"
...
if [ -n "$RANK_OVERRIDE" ]; then
    ...
    echo "  Rank:            auto from key_1pct budget (expected rank 7)"
fi
echo "=========================================================="
