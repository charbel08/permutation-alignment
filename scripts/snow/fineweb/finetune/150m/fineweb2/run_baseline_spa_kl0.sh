...
# KL is disabled (kl_lambda=0), so training uses private loss only.
# -----------------------------------------------------------------------------
...
RUN_NAME=${RUN_NAME:-baseline_private_finetune_150m_fineweb2_spa_14pct_kl0}
...
echo "=========================================================="
echo "Baseline -> private_finetune (Spanish, KL=0)"
