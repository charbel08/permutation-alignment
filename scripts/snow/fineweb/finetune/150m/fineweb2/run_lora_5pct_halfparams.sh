...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_key5pct_halfparams}
...
RUN_NAME=${RUN_NAME:-lora_private_finetune_150m_fineweb2_spa_key5pct_halfparams}
