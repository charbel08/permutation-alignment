...
# Half-size LoRA private-finetune baseline for the Spanish 5% tiered experiment.
#
...
# to be 36, so this launcher defaults to RANK_OVERRIDE=18.
...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_key5pct_halfparams_lr1e5}
...
RANK_OVERRIDE=${RANK_OVERRIDE:-18}
...
RUN_NAME=${RUN_NAME:-lora_private_finetune_150m_fineweb2_spa_key5pct_halfparams_lr1e5}
...
echo "=========================================================="
echo "LoRA private finetune (Spanish FineWeb2, key_5pct half params)"
...
echo "  Min LR:          ${MIN_LR}"
echo "  Rank override:   ${RANK_OVERRIDE} (~half of full-budget rank 36)"
echo "=========================================================="
