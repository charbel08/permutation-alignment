...
# ---------------------------------------------------------------------------
# Sweep half B: private-finetune 150M tiered pretrains on Spanish FineWeb2
# for KEY_SIZE in {7, 10, 15, 20}. Wraps the per-size launcher (run.sh).
#
# Runs sequentially. Set SKIP_EXISTING=1 (default) to skip runs whose
# `${OUTPUT_ROOT}/key${size}pct/final` already exists.
# ---------------------------------------------------------------------------

KEY_SIZES=${KEY_SIZES:-"7 10 15 20"}
...
echo "=========================================================="
echo "Spanish FineWeb2 finetune sweep B (150M tiered)"
...
echo ""
echo "=========================================================="
echo "Spanish finetune sweep B complete."
echo "=========================================================="
