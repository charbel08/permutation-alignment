...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/lora_private_finetune_150m_fineweb2_spa_14pct}
...
echo "=========================================================="
echo "LoRA baseline: private finetune (Spanish)"
...
CMD=(
    torchrun --standalone --nproc_per_node="$NGPUS" -m tiered.train.lora_private_finetune
