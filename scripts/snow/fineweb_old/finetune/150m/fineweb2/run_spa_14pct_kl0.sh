...
OUTPUT_DIR=${OUTPUT_DIR:-/work/scratch/checkpoints/fineweb/private_finetune_150m_fineweb2_spa_14pct_kl0}
...
RUN_NAME=${RUN_NAME:-private_finetune_150m_fineweb2_spa_14pct_kl0}
