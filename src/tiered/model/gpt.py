...
This module provides GPTNeoForCausalLMTiered, a GPT-Neo model with methods
...
class GPTNeoModelTiered(GPTNeoModel):
...
class GPTNeoForCausalLMTiered(GPTNeoForCausalLM):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.transformer = GPTNeoModelTiered(config)
